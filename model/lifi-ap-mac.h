...
public:
 ...
 // virtual void Start (void);
  ...
  uint8_t GetNumberOfSlotsForAccessCategory (uint8_t ac,std::string str);
...
/**
  ...
  void TransmitSlotInfos(uint32_t index);
  void SendSlotControlPackets ();
